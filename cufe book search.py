...
def getdetailurl(bookname):
    try:
        ...
        if doc('.book_list_info'):
            ...
            # href = "item.php?marc_no=316337774f6e724c4e56374f58737a694a57364d4c413d3d&list=1"
            # detailurl = 'http://202.205.213.113:8080/opac/' + href
            return '没有此书'
    except:
        pass
...
# booknamelist = pd.read_excel('wsbook.xls')
# fres= []
# for b in booknamelist.values:
#     url = getdetailurl(b)
#     if url == '没有此书':
#         res = []
#         li = '%s  没有找到'%b
...
#             f.write(content)
# fres.append(res)
# data = pd.DataFrame(fres)
# data.to_excel('wsbookinfo.xls')
